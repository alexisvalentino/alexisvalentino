...
- 😹 **I’m currently a Software Engineer at ONA**. Previously, I worked on the continuous improvement and delivery of the [DITO Telecommunity Super App](https://dito.ph/) (15M+ users) at Whale Cloud (Alibaba Group). I also co-founded [Standup AI](https://www.standupai.xyz/) and [TrustMop](https://trustmop.net/)(with [100xvc](https://app.100xvc.io/expedition)).
...
### Current Projects
- 👽 **[Marahuyo Studios®](https://marahuyostudios.com/)** - A landing page for our AI agency, We build AI solutions, automated workflows, and systems that replace repetitive processes for existing businesses.
- 👨‍💻 **[StandupAI](https://standupai.xyz)** - A sprint platform for agile teams. It tracks sprints, manages workloads, detects blockers, forecasts delivery, and summarizes team activity so you spend less time chasing status and more time shipping. 
- 🤑 **[WaitCentral](https://www.waitcentral.com/)** - A real-time queue management system that eliminates crowded waiting areas by letting customers join a virtual line from their phone. Businesses set up service categories and staffed counters through an admin dashboard, then customers scan a QR code to grab a ticket and track their position live. Staff call the next person from any desk, and updates sync instantly across the staff dashboard, customer's phone, and a TV lobby display with voice announcements. Built for clinics, government offices, service centers, and any business still relying on paper number stubs.
- 🍋‍🟩 **[TrustMop](https://trustmop.net/)** - A home services booking platform that helps customers find trusted cleaners — and helps cleaners and agencies get more jobs. Built by a local team focused on modernizing how cleaning services are booked in Metro Manila. (Grab for cleaning)
- 🚨 **[Ging](https://github.com/alexisvalentino/ging-alarmv2)** - An alarm app you literally can’t cheat. The alarm only stops once you scan your assigned QR code, forcing you to actually get out of bed before it shuts off. Built with Expo, EAS, and OTA updates for the [Replit 10th Anniversary Buildathon](https://buildathons.replit.app/projects/60e9cebc-20eb-4371-a5e5-54d2a48888e9), where it was tested by 5,000+ users directly on the Buildathon platform. I later rebuilt the entire app using Android Studio and Capacitor, turning it into a fully optimized Android APK with major improvements in stability, background reliability, UX, and overall performance. This [FINAL VERSION](https://drive.google.com/file/d/1k3np6BtrEqknpzVk1UxJv6AdYaouA9zu/view?usp=sharing) is far more aggressive than the original build, once the alarm starts, you genuinely cannot exit, ignore, or bypass it unless the correct QR code gets scanned. Built for heavy sleepers. Use with caution 😅
- 📟 **[Omni](https://agentfirstoperatingsystem.vercel.app/)** - Omni is a hybrid AI operating system simulator built in the browser, inspired by Sam Altman’s vision of an AI-native OS and the reported OpenAI × Qualcomm direction aiming toward a 2028 release. Since no one really knows how that future will actually look, I built my own interpretation of it. Instead of going fully agent-only or removing apps entirely, Omni keeps the familiar smartphone interface like the home screen, lock screen, and notifications, while adding an AI agent layer on top. Inside a Workspace, agents can plan and execute multi-step tasks like travel, scheduling, and communication, while the user stays in control. It’s not app-first or agent-only, but a mix of both. A full OS simulation exploring what an AI-native system could feel like in practice.
...
- 🧋 **[Brewloop](gobalik.com)** - My tambayan rejected the landing page I pitched earlier, so I turned it into a SaaS instead (it worked). QR-powered digital loyalty system for their business @coffeedailybyft. It replaces their paper stamp cards with a branded mini-site, scannable QR codes, and an owner dashboard — all set up in under 5 minutes. (now under gobalik.com) dev is a friend of mine, check them out.
- 🌱 **[Focus Tracker](https://github.com/alexisvalentino/focustracker)** - A productivity app that's brutally honest with you. You get a cute bear mascot that judges you and your focus sessions, And when you fail? The bear gets really disappointed and your coins suffer.
...
- 🤳 **[Hearth]()** - A social network built on presence. It's a "Digital Third Place" concept: presence instead of performance, doors instead of profiles, quiet company instead of feeds, and a consent ladder instead of random DMs.
...
- 🦗 **[AskBGC]()** - An interactive AI layer for the city, connecting physical QR codes to hyper-local navigational and contextual intelligence.
