...
- 🤑 **[WaitCentral]()** - A web-based queue management system built with Vite (Electron desktop version coming later). Customers join the queue with a QR code, while staff call the next person from any service desk. Built for clinics, government offices, restaurants, and other businesses that still rely on paper numbers or crowded waiting areas.
